...
/**
 * Post a tweet (exported function for compatibility)
 */
export async function postTweet(
  ...
  try {
    ...
    return {
      ...
      url: 'https://twitter.com/i/web/status/tweet_' + Date.now()
    };
  } catch (error) {
    return {
      success: false,
...
/**
 * Upload media to Twitter (exported function for compatibility)
 */
