...
"[project]/src/app/api/workspace/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const { data: userData, error: userError } = await supabase.from('users').select('workspace_id').eq('id', user.id).single();
        ...
        const workspace = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$database$2f$workspaceService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["WorkspaceService"].getWorkspace(userData.workspace_id);
        if (!workspace) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function PATCH(request) {
    try {
        ...
        // Update workspace
        const updatedWorkspace = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$database$2f$workspaceService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["WorkspaceService"].updateWorkspace(userData.workspace_id, updates, user.id);
        if (!updatedWorkspace) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__693cbf1b._.js.map